		...
		<div className="modal-wrapper">
			<div className="modal-body">
				<p className="about-us-content">
					...
					mission is to provide a wide range of high-quality plants that not only enhance
					the beauty of your surroundings but also contribute to a healthier and more
					sustainable lifestyle. From air-purifying plants to aromatic fragrant ones, we
